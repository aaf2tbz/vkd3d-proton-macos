...
This directory contains the current build/release guides and the consolidated
final-state record for the shipped runtime.

## Start here

| Guide | Purpose |
|---|---|
| [Final.md](Final.md) | Consolidated shipped state, feature matrix, evidence, hashes, and limitations |
