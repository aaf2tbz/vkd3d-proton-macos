# ray-query: inline ray query — dispatch path fully integrated; output-write blocker documented
...
Next: DXR - vkd3d-proton DXR 1.1 activation on top of this proven path.
...
3. vkd3d-proton DXR 1.1 activation (DXR) on top of the proven dispatch path.
