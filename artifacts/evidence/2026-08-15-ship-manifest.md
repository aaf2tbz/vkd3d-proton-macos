# release ship artifact manifest
...
- built by: scripts/ship-runtime.sh (deterministic tar: uid/gid 0, mtime 0, sorted paths, zstd -19)
...
## contents
- workspace committed state (README, history, docs/, scripts/, artifacts/evidence/)
- fork trees with git histories: sources/{MoltenVK,vkd3d-proton,SPIRV-Cross,MetalSharp}/.git
- built binaries under artifacts/bin/ + the repackaged graphics-dll.tar.zst
