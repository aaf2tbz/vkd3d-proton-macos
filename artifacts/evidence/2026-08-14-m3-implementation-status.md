# M3 implementation status (2026-08-14)
...
- Also on the STOCK shipped MoltenVK (50e41de2) -> pre-existing MVK behavior with
  this exact usage pattern, NOT caused by the M3 changes.
...
The Metal-level proof + injection + compile verification stand as the M3 evidence
