# M3 feasibility: MSL framebuffer fetch logic ops PROVEN on Apple M4 (2026-08-14)
...
Implications for M3 (docs/04 design):
- [[color(n)]] framebuffer fetch is available on Apple M4 with blending off ->
